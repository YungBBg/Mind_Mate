  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const completion = await client.chat.completions.create({
        ...
        model: "gpt-4o-mini",                 // Use this line instead if using ChatAnywhere
  ...
  useEffect(() => {
    ...
    <SafeAreaProvider>
      <SafeAreaView style={styles.container}>
        ...
        {/* Fixed Input Area - This is the most important part */}
        <KeyboardAvoidingView
          behavior={Platform.OS === "ios" ? "padding" : "height"}
          keyboardVerticalOffset={Platform.OS === "ios" ? 100 : 20}   // ← Key fix
